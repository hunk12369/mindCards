...
const front = useEditor({
  editorProps: {
    attributes: {
      class:
        "border border-purpleP p-4 min-h-[24rem] max-h-[24rem overflow-y-auto outline-none rounded-ee-md rounded-es-md prose max-w-none",
    },
  },
  content: "<p>Escribe...🔀</p>",
  extensions: [
...
const back = useEditor({
  editorProps: {
    attributes: {
      class:
        "border border-purpleP p-4 min-h-[24rem] max-h-[24rem] static overflow-y-auto outline-none rounded-ee-md rounded-es-md prose max-w-none",
    },
  },
  content: "<p>Escribe... 🔀</p>",
  extensions: [
...
const addImage = () => {
  ...
  if (url) {
    front.value.chain().focus().setImage({ src: url }).run();
  }
};
</script>
